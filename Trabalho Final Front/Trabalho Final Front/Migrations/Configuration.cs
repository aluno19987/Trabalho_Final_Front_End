    ...
    internal sealed class Configuration : DbMigrationsConfiguration<Trabalho_Final_Front.Models.FilmesDb>
    {
        ...
        protected override void Seed(FilmesDb context)
        {
            ...
            var atores = new List<Atores> {
                new Atores {IdAtor=1,Nome="Robert Downey Jr.",DataNascimento=new DateTime(1965,4,4),Imagem="img_ator_1"},
                new Atores {IdAtor=2,Nome="Chris Hemsworth",DataNascimento=new DateTime(1983,8,11),Imagem="img_ator_2"},
                new Atores {IdAtor=3,Nome="Mark Ruffalo",DataNascimento=new DateTime(1967,11,22),Imagem="img_ator_3"},
                new Atores {IdAtor=4,Nome="Chris Evans",DataNascimento=new DateTime(1981,6,13),Imagem="img_ator_4"},
                new Atores {IdAtor=5,Nome="Scarlett Johansson",DataNascimento=new DateTime(1984,11,22),Imagem="img_ator_5"},
                new Atores {IdAtor=6,Nome="Don Cheadle",DataNascimento=new DateTime(1964,11,29),Imagem="img_ator_6"},
                new Atores {IdAtor=7,Nome="Benedict Cumberbatch",DataNascimento=new DateTime(1976,7,19),Imagem="img_ator_7"},
                new Atores {IdAtor=8,Nome="Tom Holland",DataNascimento=new DateTime(1996,6,1),Imagem="img_ator_8"},
                new Atores {IdAtor=9,Nome="Chadwick Boseman",DataNascimento=new DateTime(1977,11,29),Imagem="img_ator_9"},
                new Atores {IdAtor=10,Nome="Zoe Saldana",DataNascimento=new DateTime(1978,6,19),Imagem="img_ator_10"},
                new Atores {IdAtor=11,Nome="Karen Gillan",DataNascimento=new DateTime(1987,11,28),Imagem="img_ator_11"},
                new Atores {IdAtor=12,Nome="Tom Hiddleston",DataNascimento=new DateTime(1981,2,9),Imagem="img_ator_12"},
                new Atores {IdAtor=13,Nome="Paul Bettany",DataNascimento=new DateTime(1971,5,27),Imagem="img_ator_13"},
                new Atores {IdAtor=14,Nome="Elizabeth Olsen",DataNascimento=new DateTime(1989,2,16),Imagem="img_ator_14"},
                new Atores {IdAtor=15,Nome="Anthony Mackie",DataNascimento=new DateTime(1978,9,23),Imagem="img_ator_15"},
                new Atores {IdAtor=16,Nome="Sebastian Stan",DataNascimento=new DateTime(1982,8,13),Imagem="img_ator_16"},
                new Atores {IdAtor=17,Nome="Idris Elba",DataNascimento=new DateTime(1972,9,6),Imagem="img_ator_17"},
                new Atores {IdAtor=18,Nome="Danai Gurira",DataNascimento=new DateTime(1978,2,14),Imagem="img_ator_18"},
                new Atores {IdAtor=19,Nome="Peter Dinklage",DataNascimento=new DateTime(1969,6,11),Imagem="img_ator_19"},
                new Atores {IdAtor=20,Nome="Benedict Wong",DataNascimento=new DateTime(1971,6,3),Imagem="img_ator_20"},
                new Atores {IdAtor=21,Nome="Pom Klementieff",DataNascimento=new DateTime(1986,5,3),Imagem="img_ator_21"},
                new Atores {IdAtor=22,Nome="Dave Bautista",DataNascimento=new DateTime(1969,1,18),Imagem="img_ator_22"},
                new Atores {IdAtor=23,Nome="Vin Diesel",DataNascimento=new DateTime(1967,6,18),Imagem="img_ator_23"},
                new Atores {IdAtor=24,Nome="Bradley Cooper",DataNascimento=new DateTime(1975,1,5),Imagem="img_ator_24"},
                new Atores {IdAtor=25,Nome="Gwyneth Paltrow",DataNascimento=new DateTime(1972,9,27),Imagem="img_ator_25"},
                new Atores {IdAtor=26,Nome="Josh Brolin",DataNascimento=new DateTime(1968,2,12),Imagem="img_ator_26"},
                new Atores {IdAtor=27,Nome="Chris Pratt",DataNascimento=new DateTime(1979,6,21),Imagem="img_ator_27"},
                new Atores {IdAtor=28,Nome="Ryan Reynolds",DataNascimento=new DateTime(1976,10,23),Imagem="img_ator_28"},
                new Atores {IdAtor=29,Nome="Karan Soni",DataNascimento=new DateTime(1989,1,8),Imagem="img_ator_29"},
                new Atores {IdAtor=30,Nome="Ed Skrein",DataNascimento=new DateTime(1983,3,29),Imagem="img_ator_30"},
                new Atores {IdAtor=31,Nome="Michael Benyaer",DataNascimento=new DateTime(1970,5,25),Imagem="img_ator_31"},
                new Atores {IdAtor=32,Nome="Stefan Kapicic",DataNascimento=new DateTime(1978,12,1),Imagem="img_ator_32"},
                new Atores {IdAtor=33,Nome="Brianna Hildebrand",DataNascimento=new DateTime(1996,8,14),Imagem="img_ator_33"},
                new Atores {IdAtor=34,Nome="Style Dayne",DataNascimento=new DateTime(1900,1,1),Imagem="img_ator_34"},
                new Atores {IdAtor=35,Nome="Kyle Cassie",DataNascimento=new DateTime(1976,5,6),Imagem="img_ator_35"},
                new Atores {IdAtor=36,Nome="Taylor Hickson",DataNascimento=new DateTime(1997,12,11),Imagem="img_ator_36"},
                new Atores {IdAtor=37,Nome="Randal Reeder",DataNascimento=new DateTime(1971,11,27),Imagem="img_ator_37"},
                new Atores {IdAtor=38,Nome="T.J. Miller",DataNascimento=new DateTime(1981,6,4),Imagem="img_ator_38"},
                new Atores {IdAtor=39,Nome="Morena Baccarin",DataNascimento=new DateTime(1979,6,2),Imagem="img_ator_39"},
                new Atores {IdAtor=40,Nome="Gina Carano",DataNascimento=new DateTime(1982,4,16),Imagem="img_ator_40"},
                new Atores {IdAtor=41,Nome="Sally Hawkins",DataNascimento=new DateTime(1976,4,27),Imagem="img_ator_41"},
                new Atores {IdAtor=42,Nome="Michael Shannon",DataNascimento=new DateTime(1974,8,7),Imagem="img_ator_42"},
                new Atores {IdAtor=43,Nome="Richard Jenkins",DataNascimento=new DateTime(1947,5,4),Imagem="img_ator_43"},
                new Atores {IdAtor=44,Nome="Octavia Spencer",DataNascimento=new DateTime(1972,5,25),Imagem="img_ator_44"},
                new Atores {IdAtor=45,Nome="Michael Stuhlbarg",DataNascimento=new DateTime(1968,6,5),Imagem="img_ator_45"},
                new Atores {IdAtor=46,Nome="Doug Jones",DataNascimento=new DateTime(1960,5,24),Imagem="img_ator_46"},
                new Atores {IdAtor=47,Nome="David Hewlett",DataNascimento=new DateTime(1968,4,18),Imagem="img_ator_47"},
                new Atores {IdAtor=48,Nome="Nick Searcy",DataNascimento=new DateTime(1959,3,7),Imagem="img_ator_48"},
                new Atores {IdAtor=49,Nome="Nigel Bennett",DataNascimento=new DateTime(1949,11,19),Imagem="img_ator_49"},
                new Atores {IdAtor=50,Nome="Michael Peña",DataNascimento=new DateTime(1976,1,13),Imagem="img_ator_50"},
                new Atores {IdAtor=51,Nome="Dax Shepard",DataNascimento=new DateTime(1975,1,2),Imagem="img_ator_51"},
                new Atores {IdAtor=52,Nome="Vincent D'Onofrio",DataNascimento=new DateTime(1959,6,30),Imagem="img_ator_52"},
                new Atores {IdAtor=53,Nome="Rosa Salazar",DataNascimento=new DateTime(1985,7,16),Imagem="img_ator_53"},
                new Atores {IdAtor=54,Nome="Jessica McNamee",DataNascimento=new DateTime(1900,1,1),Imagem="img_ator_54"},
                new Atores {IdAtor=55,Nome="Adam Brody",DataNascimento=new DateTime(1979,12,15),Imagem="img_ator_55"},
                new Atores {IdAtor=56,Nome="Isiah Whitlock Jr.",DataNascimento=new DateTime(1954,9,13),Imagem="img_ator_56"},
                new Atores {IdAtor=57,Nome="Jane Kaczmarek",DataNascimento=new DateTime(1955,12,21),Imagem="img_ator_57"},
                new Atores {IdAtor=58,Nome="Jennifer Lawrence",DataNascimento=new DateTime(1990,8,15),Imagem="img_ator_58"},
                new Atores {IdAtor=59,Nome="Chris Pratt",DataNascimento=new DateTime(1979,6,21),Imagem="img_ator_59"},
                new Atores {IdAtor=60,Nome="Michael Sheen",DataNascimento=new DateTime(1969,2,5),Imagem="img_ator_60"},
                new Atores {IdAtor=61,Nome="Laurence Fishburne",DataNascimento=new DateTime(1961,7,30),Imagem="img_ator_61"},
                new Atores {IdAtor=62,Nome="Andy Garcia",DataNascimento=new DateTime(1956,4,12),Imagem="img_ator_62"},
                new Atores {IdAtor=63,Nome="Julee Cerda",DataNascimento=new DateTime(1900,1,1),Imagem="img_ator_63"}
            ...
            var personagens = new List<Personagens> {
                new Personagens {IdPersonagem=1,Nome="Iron Man",Imagem="img_pers_1",FilmeFK=1, AtorFK=1},
                new Personagens {IdPersonagem=2,Nome="Thor",Imagem="img_pers_2",FilmeFK=1, AtorFK=2},
                new Personagens {IdPersonagem=3,Nome="Hulk",Imagem="img_pers_3",FilmeFK=1, AtorFK=3},
                new Personagens {IdPersonagem=4,Nome="Captain America",Imagem="img_pers_4",FilmeFK=1, AtorFK=4},
                new Personagens {IdPersonagem=5,Nome="Black Widow",Imagem="img_pers_5",FilmeFK=1, AtorFK=5},
                new Personagens {IdPersonagem=6,Nome="War Machine",Imagem="img_pers_6",FilmeFK=1, AtorFK=6},
                new Personagens {IdPersonagem=1,Nome="Doctor Strange",Imagem="img_pers_7",FilmeFK=1, AtorFK=7},
                new Personagens {IdPersonagem=8,Nome="Spider-Man",Imagem="img_pers_8",FilmeFK=1, AtorFK=8},
                new Personagens {IdPersonagem=9,Nome="Black Panther",Imagem="img_pers_9",FilmeFK=1, AtorFK=9},
                new Personagens {IdPersonagem=10,Nome="Gamora",Imagem="img_pers_10",FilmeFK=1, AtorFK=10},
                new Personagens {IdPersonagem=11,Nome="Nebula",Imagem="img_pers_11",FilmeFK=1, AtorFK=11},
                new Personagens {IdPersonagem=12,Nome="Loki",Imagem="img_pers_12",FilmeFK=1, AtorFK=12},
                new Personagens {IdPersonagem=13,Nome="Vision",Imagem="img_pers_13",FilmeFK=1, AtorFK=13},
                new Personagens {IdPersonagem=14,Nome="Scarlet Witch",Imagem="img_pers_14",FilmeFK=1, AtorFK=14},
                new Personagens {IdPersonagem=15,Nome="Falcon",Imagem="img_pers_15",FilmeFK=1, AtorFK=15},
                new Personagens {IdPersonagem=16,Nome="Winter Soldier",Imagem="img_pers_16",FilmeFK=1, AtorFK=16},
                new Personagens {IdPersonagem=17,Nome="Heimdall",Imagem="img_pers_17",FilmeFK=1, AtorFK=17},
                new Personagens {IdPersonagem=18,Nome="Okoye",Imagem="img_pers_18",FilmeFK=1, AtorFK=18},
                new Personagens {IdPersonagem=19,Nome="Eitri",Imagem="img_pers_19",FilmeFK=1, AtorFK=19},
                new Personagens {IdPersonagem=20,Nome="Wong",Imagem="img_pers_20",FilmeFK=1, AtorFK=20},
                new Personagens {IdPersonagem=21,Nome="Mantis",Imagem="img_pers_21",FilmeFK=1, AtorFK=21},
                new Personagens {IdPersonagem=22,Nome="Drax",Imagem="img_pers_22",FilmeFK=1, AtorFK=22},
                new Personagens {IdPersonagem=23,Nome="Groot",Imagem="img_pers_23",FilmeFK=1, AtorFK=23},
                new Personagens {IdPersonagem=24,Nome="Rocket",Imagem="img_pers_24",FilmeFK=1, AtorFK=24},
                new Personagens {IdPersonagem=25,Nome="Pepper Potts",Imagem="img_pers_25",FilmeFK=1, AtorFK=25},
                new Personagens {IdPersonagem=26,Nome="Thanos",Imagem="img_pers_26",FilmeFK=1, AtorFK=26},
                new Personagens {IdPersonagem=27,Nome="Star-Lord",Imagem="img_pers_27",FilmeFK=1, AtorFK=27},
                new Personagens {IdPersonagem=28,Nome="Deadpool",Imagem="img_pers_28",FilmeFK=2, AtorFK=28},
                new Personagens {IdPersonagem=29,Nome="Dopinder",Imagem="img_pers_29",FilmeFK=2, AtorFK=29},
                new Personagens {IdPersonagem=30,Nome="Ajax",Imagem="img_pers_30",FilmeFK=2, AtorFK=30},
                new Personagens {IdPersonagem=31,Nome="Colossus",Imagem="img_pers_31",FilmeFK=2, AtorFK=31},
                new Personagens {IdPersonagem=32,Nome="Voice of Colossus",Imagem="img_pers_32",FilmeFK=2, AtorFK=32},
                new Personagens {IdPersonagem=33,Nome="Negasonic Teenage Warhead",Imagem="img_pers_33",FilmeFK=2, AtorFK=33},
                new Personagens {IdPersonagem=34,Nome="Jeremy (Pizza Guy)",Imagem="img_pers_34",FilmeFK=2, AtorFK=34},
                new Personagens {IdPersonagem=35,Nome="Gavin Merchant",Imagem="img_pers_35",FilmeFK=2, AtorFK=35},
                new Personagens {IdPersonagem=36,Nome="Meghan Orlovsky",Imagem="img_pers_36",FilmeFK=2, AtorFK=36},
                new Personagens {IdPersonagem=37,Nome="Buck",Imagem="img_pers_37",FilmeFK=2, AtorFK=37},
                new Personagens {IdPersonagem=38,Nome="Weasel",Imagem="img_pers_38",FilmeFK=2, AtorFK=38},
                new Personagens {IdPersonagem=39,Nome="Vanessa",Imagem="img_pers_39",FilmeFK=2, AtorFK=39},
                new Personagens {IdPersonagem=40,Nome="Angel Dust",Imagem="img_pers_40",FilmeFK=2, AtorFK=40},
                new Personagens {IdPersonagem=41,Nome="Elisa Esposito",Imagem="img_pers_41",FilmeFK=3, AtorFK=41},
                new Personagens {IdPersonagem=42,Nome="Richard Strickland",Imagem="img_pers_42",FilmeFK=3, AtorFK=42},
                new Personagens {IdPersonagem=43,Nome="Giles",Imagem="img_pers_43",FilmeFK=3, AtorFK=43},
                new Personagens {IdPersonagem=44,Nome="Zelda Fuller",Imagem="img_pers_44",FilmeFK=3, AtorFK=44},
                new Personagens {IdPersonagem=45,Nome="Dr. Robert Hoffstetler",Imagem="img_pers_45",FilmeFK=3, AtorFK=45},
                new Personagens {IdPersonagem=46,Nome="Amphibian Man",Imagem="img_pers_46",FilmeFK=3, AtorFK=46},
                new Personagens {IdPersonagem=47,Nome="Fleming",Imagem="img_pers_47",FilmeFK=3, AtorFK=47},
                new Personagens {IdPersonagem=48,Nome="General Hoyt",Imagem="img_pers_48",FilmeFK=3, AtorFK=48},
                new Personagens {IdPersonagem=49,Nome="Mihalkov",Imagem="img_pers_49",FilmeFK=3, AtorFK=49},
                new Personagens {IdPersonagem=50,Nome="Ponch",Imagem="img_pers_50",FilmeFK=4, AtorFK=50},
                new Personagens {IdPersonagem=51,Nome="Jon",Imagem="img_pers_51",FilmeFK=4, AtorFK=51},
                new Personagens {IdPersonagem=52,Nome="Ray Kurtz",Imagem="img_pers_52",FilmeFK=4, AtorFK=52},
                new Personagens {IdPersonagem=53,Nome="Ava Perez",Imagem="img_pers_53",FilmeFK=4, AtorFK=53},
                new Personagens {IdPersonagem=54,Nome="Lindsey Taylor",Imagem="img_pers_54",FilmeFK=4, AtorFK=54},
                new Personagens {IdPersonagem=55,Nome="Clay Allen",Imagem="img_pers_55",FilmeFK=4, AtorFK=55},
                new Personagens {IdPersonagem=56,Nome="Peterson",Imagem="img_pers_56",FilmeFK=4, AtorFK=56},
                new Personagens {IdPersonagem=57,Nome="Captain Jane Lindel",Imagem="img_pers_57",FilmeFK=4, AtorFK=57},
                new Personagens {IdPersonagem=58,Nome="Aurora Lane",Imagem="img_pers_58",FilmeFK=5, AtorFK=58},
                new Personagens {IdPersonagem=59,Nome="Jim Preston",Imagem="img_pers_59",FilmeFK=5, AtorFK=59},
                new Personagens {IdPersonagem=60,Nome="Arthur",Imagem="img_pers_60",FilmeFK=5, AtorFK=60},
                new Personagens {IdPersonagem=61,Nome="Gus Mancuso",Imagem="img_pers_61",FilmeFK=5, AtorFK=61},
                new Personagens {IdPersonagem=62,Nome="Captain Norris",Imagem="img_pers_62",FilmeFK=5, AtorFK=62},
                new Personagens {IdPersonagem=63,Nome="Instructor (Hologram)",Imagem="img_pers_63",FilmeFK=5, AtorFK=63}
